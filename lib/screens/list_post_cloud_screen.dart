...
import 'package:pmsn20232/screens/detail_post.dart';
        ...
        if (snapshot.hasData) {
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final carbohidratos = snapshot.data!.docs[index].get('carbohidratos');
                final descripcion = snapshot.data!.docs[index].get('descripcion');
