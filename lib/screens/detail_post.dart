...
import 'package:pmsn20232/services/post_collection_fb.dart';
import '../models/post_model.dart';

class DetailPost extends StatefulWidget {
  DetailPost({Key? key, required this.postModel}) : super(key: key);
                  ...
                  actions: [
                    IconButton(
                      onPressed: () =>{
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: ((context) => EditPost(postModel: widget.postModel)))),
                      },
                        ...
                        builder: (context){
                          return AlertDialog(
                            ...
                            actions: [
                              TextButton(
                                onPressed: (){
                                  postCollection.delFavorite(widget.postModel!.id!);
